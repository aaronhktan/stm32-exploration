#[doc = "Reader of register CAN_MSR"]
pub type R = crate::R<u32, super::CAN_MSR>;
#[doc = "Writer for register CAN_MSR"]
pub type W = crate::W<u32, super::CAN_MSR>;
#[doc = "Register CAN_MSR `reset()`'s with value 0"]
impl crate::ResetValue for super::CAN_MSR {
    type Type = u32;
    #[inline(always)]
