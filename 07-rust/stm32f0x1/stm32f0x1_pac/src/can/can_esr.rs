#[doc = "Reader of register CAN_ESR"]
pub type R = crate::R<u32, super::CAN_ESR>;
#[doc = "Writer for register CAN_ESR"]
pub type W = crate::W<u32, super::CAN_ESR>;
#[doc = "Register CAN_ESR `reset()`'s with value 0"]
impl crate::ResetValue for super::CAN_ESR {
    type Type = u32;
    #[inline(always)]
