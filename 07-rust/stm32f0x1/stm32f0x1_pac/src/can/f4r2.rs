#[doc = "Reader of register F4R2"]
pub type R = crate::R<u32, super::F4R2>;
#[doc = "Writer for register F4R2"]
pub type W = crate::W<u32, super::F4R2>;
#[doc = "Register F4R2 `reset()`'s with value 0"]
impl crate::ResetValue for super::F4R2 {
    type Type = u32;
    #[inline(always)]
