#[doc = "Reader of register CAN_TDL1R"]
pub type R = crate::R<u32, super::CAN_TDL1R>;
#[doc = "Writer for register CAN_TDL1R"]
pub type W = crate::W<u32, super::CAN_TDL1R>;
#[doc = "Register CAN_TDL1R `reset()`'s with value 0"]
impl crate::ResetValue for super::CAN_TDL1R {
    type Type = u32;
    #[inline(always)]
