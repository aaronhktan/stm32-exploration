#[doc = "Reader of register F3R1"]
pub type R = crate::R<u32, super::F3R1>;
#[doc = "Writer for register F3R1"]
pub type W = crate::W<u32, super::F3R1>;
#[doc = "Register F3R1 `reset()`'s with value 0"]
impl crate::ResetValue for super::F3R1 {
    type Type = u32;
    #[inline(always)]
