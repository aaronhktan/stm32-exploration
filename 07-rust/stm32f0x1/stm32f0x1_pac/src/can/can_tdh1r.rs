#[doc = "Reader of register CAN_TDH1R"]
pub type R = crate::R<u32, super::CAN_TDH1R>;
#[doc = "Writer for register CAN_TDH1R"]
pub type W = crate::W<u32, super::CAN_TDH1R>;
#[doc = "Register CAN_TDH1R `reset()`'s with value 0"]
impl crate::ResetValue for super::CAN_TDH1R {
    type Type = u32;
    #[inline(always)]
