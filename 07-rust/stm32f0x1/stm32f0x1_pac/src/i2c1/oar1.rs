...
#[doc = "Reader of field `OA1_1`"]
pub type OA1_1_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `OA1_1`"]
pub struct OA1_1_W<'a> {
    w: &'a mut W,
}
impl<'a> OA1_1_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
#[doc = "Reader of field `OA1_8`"]
pub type OA1_8_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `OA1_8`"]
pub struct OA1_8_W<'a> {
    w: &'a mut W,
}
impl<'a> OA1_8_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl R {
    ...
    pub fn oa1_8(&self) -> OA1_8_R {
        OA1_8_R::new(((self.bits >> 8) & 0x03) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 1:7 - Interface address"]
    #[inline(always)]
    pub fn oa1_1(&mut self) -> OA1_1_W {
        OA1_1_W { w: self }
    }
    #[doc = "Bits 8:9 - Interface address"]
    #[inline(always)]
    pub fn oa1_8(&mut self) -> OA1_8_W {
        OA1_8_W { w: self }
    }
    #[doc = "Bit 10 - Own Address 1 10-bit mode"]
    #[inline(always)]
