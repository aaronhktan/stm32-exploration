...
#[doc = "Reader of field `SADD8`"]
pub type SADD8_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `SADD8`"]
pub struct SADD8_W<'a> {
    w: &'a mut W,
}
impl<'a> SADD8_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
#[doc = "Reader of field `SADD1`"]
pub type SADD1_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `SADD1`"]
pub struct SADD1_W<'a> {
    w: &'a mut W,
}
impl<'a> SADD1_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
#[doc = "Reader of field `SADD0`"]
pub type SADD0_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `SADD0`"]
pub struct SADD0_W<'a> {
    w: &'a mut W,
}
impl<'a> SADD0_W<'a> {
    #[doc = r"Sets the field bit"]
...
impl R {
    ...
    pub fn sadd8(&self) -> SADD8_R {
        SADD8_R::new(((self.bits >> 8) & 0x03) as u8)
    }
