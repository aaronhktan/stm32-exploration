...
#[doc = "Reader of field `IC2PCS`"]
pub type IC2PCS_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `IC2PCS`"]
...
#[doc = "Reader of field `IC1PCS`"]
pub type IC1PCS_R = crate::R<u8, u8>;
#[doc = "Write proxy for field `IC1PCS`"]
pub struct IC1PCS_W<'a> {
    w: &'a mut W,
}
impl<'a> IC1PCS_W<'a> {
    #[doc = r"Writes raw bits to the field"]
...
impl R {
    ...
    pub fn ic2pcs(&self) -> IC2PCS_R {
        IC2PCS_R::new(((self.bits >> 10) & 0x03) as u8)
    }
    ...
    #[inline(always)]
    pub fn ic1pcs(&self) -> IC1PCS_R {
        IC1PCS_R::new(((self.bits >> 2) & 0x03) as u8)
    }
...
impl W {
    ...
    #[doc = "Bits 2:3 - Input capture 1 prescaler"]
    #[inline(always)]
    pub fn ic1pcs(&mut self) -> IC1PCS_W {
        IC1PCS_W { w: self }
    }
    #[doc = "Bits 0:1 - Capture/Compare 1 selection"]
    #[inline(always)]
