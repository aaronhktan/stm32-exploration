#[doc = "Reader of register SYSCFG_EXTICR4"]
pub type R = crate::R<u32, super::SYSCFG_EXTICR4>;
#[doc = "Writer for register SYSCFG_EXTICR4"]
pub type W = crate::W<u32, super::SYSCFG_EXTICR4>;
#[doc = "Register SYSCFG_EXTICR4 `reset()`'s with value 0"]
impl crate::ResetValue for super::SYSCFG_EXTICR4 {
    type Type = u32;
    #[inline(always)]
