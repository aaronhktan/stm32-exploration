#[doc = "Reader of register SYSCFG_EXTICR1"]
pub type R = crate::R<u32, super::SYSCFG_EXTICR1>;
#[doc = "Writer for register SYSCFG_EXTICR1"]
pub type W = crate::W<u32, super::SYSCFG_EXTICR1>;
#[doc = "Register SYSCFG_EXTICR1 `reset()`'s with value 0"]
impl crate::ResetValue for super::SYSCFG_EXTICR1 {
    type Type = u32;
    #[inline(always)]
