#[doc = "Reader of register SYSCFG_EXTICR2"]
pub type R = crate::R<u32, super::SYSCFG_EXTICR2>;
#[doc = "Writer for register SYSCFG_EXTICR2"]
pub type W = crate::W<u32, super::SYSCFG_EXTICR2>;
#[doc = "Register SYSCFG_EXTICR2 `reset()`'s with value 0"]
impl crate::ResetValue for super::SYSCFG_EXTICR2 {
    type Type = u32;
    #[inline(always)]
