#[doc = "Reader of register S0CR"]
pub type R = crate::R<u32, super::S0CR>;
#[doc = "Writer for register S0CR"]
pub type W = crate::W<u32, super::S0CR>;
#[doc = "Register S0CR `reset()`'s with value 0"]
impl crate::ResetValue for super::S0CR {
    type Type = u32;
    #[inline(always)]
