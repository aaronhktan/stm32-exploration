#[doc = "Reader of register S4CR"]
pub type R = crate::R<u32, super::S4CR>;
#[doc = "Writer for register S4CR"]
pub type W = crate::W<u32, super::S4CR>;
#[doc = "Register S4CR `reset()`'s with value 0"]
impl crate::ResetValue for super::S4CR {
    type Type = u32;
    #[inline(always)]
