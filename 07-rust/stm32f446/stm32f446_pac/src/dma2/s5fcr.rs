#[doc = "Reader of register S5FCR"]
pub type R = crate::R<u32, super::S5FCR>;
#[doc = "Writer for register S5FCR"]
pub type W = crate::W<u32, super::S5FCR>;
#[doc = "Register S5FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::S5FCR {
    type Type = u32;
    #[inline(always)]
