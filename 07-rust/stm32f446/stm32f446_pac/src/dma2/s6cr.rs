#[doc = "Reader of register S6CR"]
pub type R = crate::R<u32, super::S6CR>;
#[doc = "Writer for register S6CR"]
pub type W = crate::W<u32, super::S6CR>;
#[doc = "Register S6CR `reset()`'s with value 0"]
impl crate::ResetValue for super::S6CR {
    type Type = u32;
    #[inline(always)]
