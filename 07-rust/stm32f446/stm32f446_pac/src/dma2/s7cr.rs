#[doc = "Reader of register S7CR"]
pub type R = crate::R<u32, super::S7CR>;
#[doc = "Writer for register S7CR"]
pub type W = crate::W<u32, super::S7CR>;
#[doc = "Register S7CR `reset()`'s with value 0"]
impl crate::ResetValue for super::S7CR {
    type Type = u32;
    #[inline(always)]
