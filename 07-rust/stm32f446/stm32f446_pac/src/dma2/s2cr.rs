#[doc = "Reader of register S2CR"]
pub type R = crate::R<u32, super::S2CR>;
#[doc = "Writer for register S2CR"]
pub type W = crate::W<u32, super::S2CR>;
#[doc = "Register S2CR `reset()`'s with value 0"]
impl crate::ResetValue for super::S2CR {
    type Type = u32;
    #[inline(always)]
