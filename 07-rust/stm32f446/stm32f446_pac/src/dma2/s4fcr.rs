#[doc = "Reader of register S4FCR"]
pub type R = crate::R<u32, super::S4FCR>;
#[doc = "Writer for register S4FCR"]
pub type W = crate::W<u32, super::S4FCR>;
#[doc = "Register S4FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::S4FCR {
    type Type = u32;
    #[inline(always)]
