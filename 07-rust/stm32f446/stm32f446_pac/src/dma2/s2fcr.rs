#[doc = "Reader of register S2FCR"]
pub type R = crate::R<u32, super::S2FCR>;
#[doc = "Writer for register S2FCR"]
pub type W = crate::W<u32, super::S2FCR>;
#[doc = "Register S2FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::S2FCR {
    type Type = u32;
    #[inline(always)]
