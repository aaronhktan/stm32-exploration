#[doc = "Reader of register S6FCR"]
pub type R = crate::R<u32, super::S6FCR>;
#[doc = "Writer for register S6FCR"]
pub type W = crate::W<u32, super::S6FCR>;
#[doc = "Register S6FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::S6FCR {
    type Type = u32;
    #[inline(always)]
