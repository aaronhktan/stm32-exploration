#[doc = "Reader of register S1FCR"]
pub type R = crate::R<u32, super::S1FCR>;
#[doc = "Writer for register S1FCR"]
pub type W = crate::W<u32, super::S1FCR>;
#[doc = "Register S1FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::S1FCR {
    type Type = u32;
    #[inline(always)]
