#[doc = "Reader of register S0FCR"]
pub type R = crate::R<u32, super::S0FCR>;
#[doc = "Writer for register S0FCR"]
pub type W = crate::W<u32, super::S0FCR>;
#[doc = "Register S0FCR `reset()`'s with value 0x21"]
impl crate::ResetValue for super::S0FCR {
    type Type = u32;
    #[inline(always)]
