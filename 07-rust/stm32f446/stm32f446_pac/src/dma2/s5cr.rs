#[doc = "Reader of register S5CR"]
pub type R = crate::R<u32, super::S5CR>;
#[doc = "Writer for register S5CR"]
pub type W = crate::W<u32, super::S5CR>;
#[doc = "Register S5CR `reset()`'s with value 0"]
impl crate::ResetValue for super::S5CR {
    type Type = u32;
    #[inline(always)]
