#[doc = "Reader of register S1CR"]
pub type R = crate::R<u32, super::S1CR>;
#[doc = "Writer for register S1CR"]
pub type W = crate::W<u32, super::S1CR>;
#[doc = "Register S1CR `reset()`'s with value 0"]
impl crate::ResetValue for super::S1CR {
    type Type = u32;
    #[inline(always)]
