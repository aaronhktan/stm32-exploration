#[doc = "Reader of register S3CR"]
pub type R = crate::R<u32, super::S3CR>;
#[doc = "Writer for register S3CR"]
pub type W = crate::W<u32, super::S3CR>;
#[doc = "Register S3CR `reset()`'s with value 0"]
impl crate::ResetValue for super::S3CR {
    type Type = u32;
    #[inline(always)]
