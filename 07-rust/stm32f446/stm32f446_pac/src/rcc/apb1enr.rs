...
#[doc = "Reader of field `I2CFMP1EN`"]
pub type I2CFMP1EN_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `I2CFMP1EN`"]
pub struct I2CFMP1EN_W<'a> {
    w: &'a mut W,
}
impl<'a> I2CFMP1EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub type CAN2EN_R = crate::R<bool, bool>;
...
#[doc = "Reader of field `CEC`"]
pub type CEC_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `CEC`"]
pub struct CEC_W<'a> {
    w: &'a mut W,
}
impl<'a> CEC_W<'a> {
...
impl R {
    ...
    #[doc = "Bit 16 - SPDIF-IN clock enable"]
    #[inline(always)]
    pub fn spdifen(&self) -> SPDIFEN_R {
        SPDIFEN_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    ...
    #[doc = "Bit 24 - I2CFMP1 clock enable"]
    #[inline(always)]
    pub fn i2cfmp1en(&self) -> I2CFMP1EN_R {
        I2CFMP1EN_R::new(((self.bits >> 24) & 0x01) != 0)
    }
    ...
    #[doc = "Bit 27 - CEC interface clock enable"]
    #[inline(always)]
    pub fn cec(&self) -> CEC_R {
        CEC_R::new(((self.bits >> 27) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 24 - I2CFMP1 clock enable"]
    #[inline(always)]
    pub fn i2cfmp1en(&mut self) -> I2CFMP1EN_W {
        I2CFMP1EN_W { w: self }
    }
    #[doc = "Bit 25 - CAN 1 clock enable"]
    #[inline(always)]
