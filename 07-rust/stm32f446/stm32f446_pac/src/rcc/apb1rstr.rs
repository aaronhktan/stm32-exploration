...
pub type WWDGRST_R = crate::R<bool, bool>;
...
pub type UART2RST_R = crate::R<bool, bool>;
...
#[doc = "Reader of field `I2CFMP1RST`"]
pub type I2CFMP1RST_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `I2CFMP1RST`"]
pub struct I2CFMP1RST_W<'a> {
    w: &'a mut W,
}
impl<'a> I2CFMP1RST_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
pub type CAN2RST_R = crate::R<bool, bool>;
...
impl R {
    ...
    pub fn spdifrst(&self) -> SPDIFRST_R {
        SPDIFRST_R::new(((self.bits >> 16) & 0x01) != 0)
    }
    ...
    #[doc = "Bit 24 - I2CFMP1 reset"]
    #[inline(always)]
    pub fn i2cfmp1rst(&self) -> I2CFMP1RST_R {
        I2CFMP1RST_R::new(((self.bits >> 24) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 24 - I2CFMP1 reset"]
    #[inline(always)]
    pub fn i2cfmp1rst(&mut self) -> I2CFMP1RST_W {
        I2CFMP1RST_W { w: self }
    }
    #[doc = "Bit 25 - CAN1 reset"]
    #[inline(always)]
