#[doc = "Reader of register DBGMCU_APB1_FZ"]
pub type R = crate::R<u32, super::DBGMCU_APB1_FZ>;
#[doc = "Writer for register DBGMCU_APB1_FZ"]
pub type W = crate::W<u32, super::DBGMCU_APB1_FZ>;
#[doc = "Register DBGMCU_APB1_FZ `reset()`'s with value 0"]
impl crate::ResetValue for super::DBGMCU_APB1_FZ {
    type Type = u32;
    #[inline(always)]
...
#[doc = "Reader of field `DBG_IWDEG_STOP`"]
pub type DBG_IWDEG_STOP_R = crate::R<bool, bool>;
#[doc = "Write proxy for field `DBG_IWDEG_STOP`"]
pub struct DBG_IWDEG_STOP_W<'a> {
    w: &'a mut W,
}
impl<'a> DBG_IWDEG_STOP_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    ...
    pub fn dbg_iwdeg_stop(&self) -> DBG_IWDEG_STOP_R {
        DBG_IWDEG_STOP_R::new(((self.bits >> 12) & 0x01) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 12 - DBG_IWDEG_STOP"]
    #[inline(always)]
    pub fn dbg_iwdeg_stop(&mut self) -> DBG_IWDEG_STOP_W {
        DBG_IWDEG_STOP_W { w: self }
    }
    #[doc = "Bit 21 - DBG_J2C1_SMBUS_TIMEOUT"]
    #[inline(always)]
