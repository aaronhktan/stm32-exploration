#[doc = "Reader of register F6R2"]
pub type R = crate::R<u32, super::F6R2>;
#[doc = "Writer for register F6R2"]
pub type W = crate::W<u32, super::F6R2>;
#[doc = "Register F6R2 `reset()`'s with value 0"]
impl crate::ResetValue for super::F6R2 {
    type Type = u32;
    #[inline(always)]
