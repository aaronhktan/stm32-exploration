#[doc = "Reader of register F6R1"]
pub type R = crate::R<u32, super::F6R1>;
#[doc = "Writer for register F6R1"]
pub type W = crate::W<u32, super::F6R1>;
#[doc = "Register F6R1 `reset()`'s with value 0"]
impl crate::ResetValue for super::F6R1 {
    type Type = u32;
    #[inline(always)]
