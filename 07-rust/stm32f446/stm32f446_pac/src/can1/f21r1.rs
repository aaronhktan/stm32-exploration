#[doc = "Reader of register F21R1"]
pub type R = crate::R<u32, super::F21R1>;
#[doc = "Writer for register F21R1"]
pub type W = crate::W<u32, super::F21R1>;
#[doc = "Register F21R1 `reset()`'s with value 0"]
impl crate::ResetValue for super::F21R1 {
    type Type = u32;
    #[inline(always)]
