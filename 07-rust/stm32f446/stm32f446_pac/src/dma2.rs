...
#[doc(hidden)]
pub struct _LIFCR;
#[doc = "`read()` method returns [lifcr::R](lifcr::R) reader structure"]
impl crate::Readable for LIFCR {}
...
#[doc(hidden)]
pub struct _HIFCR;
#[doc = "`read()` method returns [hifcr::R](hifcr::R) reader structure"]
impl crate::Readable for HIFCR {}
