#[doc = "Reader of register FIREWALL_CR"]
pub type R = crate::R<u32, super::FIREWALL_CR>;
#[doc = "Writer for register FIREWALL_CR"]
pub type W = crate::W<u32, super::FIREWALL_CR>;
#[doc = "Register FIREWALL_CR `reset()`'s with value 0"]
impl crate::ResetValue for super::FIREWALL_CR {
    type Type = u32;
    #[inline(always)]
