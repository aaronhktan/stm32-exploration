#[doc = "Reader of register FIREWALL_CSL"]
pub type R = crate::R<u32, super::FIREWALL_CSL>;
#[doc = "Writer for register FIREWALL_CSL"]
pub type W = crate::W<u32, super::FIREWALL_CSL>;
#[doc = "Register FIREWALL_CSL `reset()`'s with value 0"]
impl crate::ResetValue for super::FIREWALL_CSL {
    type Type = u32;
    #[inline(always)]
