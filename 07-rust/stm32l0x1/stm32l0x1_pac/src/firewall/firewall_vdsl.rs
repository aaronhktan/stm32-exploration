#[doc = "Reader of register FIREWALL_VDSL"]
pub type R = crate::R<u32, super::FIREWALL_VDSL>;
#[doc = "Writer for register FIREWALL_VDSL"]
pub type W = crate::W<u32, super::FIREWALL_VDSL>;
#[doc = "Register FIREWALL_VDSL `reset()`'s with value 0"]
impl crate::ResetValue for super::FIREWALL_VDSL {
    type Type = u32;
    #[inline(always)]
