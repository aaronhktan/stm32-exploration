#[doc = "Reader of register FIREWALL_NVDSL"]
pub type R = crate::R<u32, super::FIREWALL_NVDSL>;
#[doc = "Writer for register FIREWALL_NVDSL"]
pub type W = crate::W<u32, super::FIREWALL_NVDSL>;
#[doc = "Register FIREWALL_NVDSL `reset()`'s with value 0"]
impl crate::ResetValue for super::FIREWALL_NVDSL {
    type Type = u32;
    #[inline(always)]
